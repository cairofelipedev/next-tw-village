    ...
    <>
      ...
      <CustomModal visible={showModal} onClose={() => setShowModal(false)}>
        <div className="w-96 rounded bg-black p-5 md:w-1/2">
          <h1 className="text-center text-2xl font-bold text-white">Comodidade</h1>
          <h2 className="py-4 text-center text-xl text-white">
            Encontre o que você precisa em um so lugar
          </h2>
          <ul className="list-disc pl-4">
            <li className="text-orange-500">
              <p className="py-1 text-white">Creche</p>
            </li>
            <li className="text-orange-500">
              <p className="py-1 text-white">Panificadora</p>
            </li>
            <li className="text-orange-500">
              <p className="py-1 text-white">Lojas de Conveniência</p>
            </li>
          </ul>
          <Image
            className="rounded"
